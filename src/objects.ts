...
export function isCorrect(question: Question, answer: string): boolean {
    ...
    let lowerCaseAnswer: string = trimmedAnswer.toLowerCase();
    let trimmedExpected: string = question.expected.trim();
    let lowerCaseExpected: string = trimmedExpected.toLowerCase();
...
export function toShortForm(question: Question): string {
    let idStr: string = question.id.toString();
    let shortenedName: string = question.name.slice(0, 10);
    return idStr + ": " + shortenedName;
}
